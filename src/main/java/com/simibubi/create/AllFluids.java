...
public class AllFluids {
	...
	public static final FluidEntry<ForgeFlowingFluid.Flowing> HONEY =
			REGISTRATE.standardFluid("honey", SolidRenderedPlaceableFluidType.create(0xEAAE2F, () -> 1f / 8f))
					.lang("Honey")
	...
	public static void registerFluidInteractions() {
		FluidInteractionRegistry.addInteraction(ForgeMod.LAVA_TYPE.get(), new InteractionInformation(
				...
				fluidState -> fluidState.isSource() ? Blocks.OBSIDIAN.defaultBlockState() : Blocks.STONE.defaultBlockState()
		));
	}
