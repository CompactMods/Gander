...
//	{
//		RenderSystem.assertOnRenderThread(); // orInit
//		var maxSize = RenderSystem.getDevice().getMaxTextureSize();
//		var maxLayers = maxSupportedTextureLayers();
//        // TODO Port 21.5: needed?		RenderSystem.getDevice().getMaxTextureSize();
