...
public interface PipelineGeometryUploadPhase<TCtx> extends PipelinePhase {
    ...
    void upload(PipelineState state, TCtx context, GuiGraphics graphics, Camera camera, PoseStack poseStack, Matrix4f projectionMatrix, Matrix4f modelViewMatrix, float partialTicks);
}
